            ...
            <?php if (!empty($facturas)): ?>
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <td><?= esc($factura['nombre']) . ' ' . esc($factura['apellido']) ?></td>
                ...
                <?php else: ?>
                    <div class="alert alert-info text-center">
                        <i class="bi bi-info-circle me-1"></i> Aún no se han registrado compras.
                    </div>
                <?php endif; ?> 
            <div class="text-end mt-3"> 
                <a href="<?= base_url('panel/admin') ?>" class="btn btn-secondary"> 
